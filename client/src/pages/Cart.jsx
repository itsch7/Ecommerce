...
const Cart = () => {
 ...
 useEffect(() => {
     const makeRequest = async () => {
      try
      {
        const req = await userRequest.post("http://localhost:5000/api/checkout/payment", {
        tokenId: stripeToken.id,
        amount:cart.totalPrice*100,
      });
      // navigate.push('/success',{data:req.data});
      ...
      <Wrapper>
        ...
        <Bottom>
          ...
          <Summary>
            ...
            amount={cart.totalPrice*100}
            token={onToken}
            stripeKey="pk_test_51Lr0vHGiCKrdb9djs5HwbHwJo4QHREgHmfGaPl0URtvZXYbpP3D3BPksl0M0raAeaSWh0zoq01jxWQIjXhbnB5Rk00d8JDYCMa">
